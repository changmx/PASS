...
CPU and GPU use the same double-precision composition coefficients. GPU split maps
retain double precision for element lengths, substep lengths and accumulated
multipole momentum increments, including transport between internal space-charge nodes.
