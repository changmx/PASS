...
TwissItem names are prefixed with `twiss_` (e.g. `twiss_TSF1_s1.500`) to avoid collision with inserted element names (e.g. `TSF1_s1.500`) in the Sequence's OrderedDict.
